...
namespace Practica1.Controllers
{
    public class Usuarios2Controller : Controller
    {
        ...
        public Usuarios2Controller(UsuarioContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idusuario,Nombre,Contrasenia,Genero,Direccion,Pasatiempo,Curso,Conocimiento")] Usuario usuario)
        {
